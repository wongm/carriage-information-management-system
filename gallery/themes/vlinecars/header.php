...
<title>V/LineCars.com - <?php printGalleryTitle(); ?></title>
...
ddaccordion.init({
        ...
        defaultexpanded: [<?=GALLERY_MENU_TAB?>], //index of content(s) open by default [index1, index2, etc]. [] denotes no content
...
<a href="/" title="V/LineCars.com Home">Home</a> &raquo
