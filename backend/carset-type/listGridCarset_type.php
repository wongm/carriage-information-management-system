...
if ($thisAction=="Update")
{
	...
	$sqlUpdate = "UPDATE carset_type SET id = '$thisId' , family = '$thisFamily' , description = '$thisDescription' , cars = '$thisCars'  WHERE id = '$thisId'";
...
if ($thisAction=="Insert")
{
	...
	$sqlInsert = "INSERT INTO carset_type (id , family , description , cars ) VALUES ('$thisId' , '$thisFamily' , '$thisDescription' , '$thisCars' )";
...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM carset_type WHERE id = '$thisId'";
...
<input type="hidden" name="thisIdField" value="<? echo $thisId; ?>">
	<TR BGCOLOR="#FF6666">
		...
		<TD><input type"text" name="thisFamilyField" value=""></TD>
		<TD><input type"text" name="thisDescriptionField" value=""></TD>
		<TD><input type"text" name="thisCarsField" value=""></TD>
...
<input type="hidden" name="thisIdField" value="<? echo $thisId; ?>">
	<TR BGCOLOR="<? echo $bgColor; ?>">
		...
		<TD><input type"text" name="thisFamilyField" value="<? echo $thisFamily; ?>"></TD>
		<TD><input type"text" name="thisDescriptionField" value="<? echo $thisDescription; ?>"></TD>
		<TD><input type"text" name="thisCarsField" value="<? echo $thisCars; ?>"></TD>
