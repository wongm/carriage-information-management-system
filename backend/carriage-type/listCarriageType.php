<?php
$pageTitle = 'Edit Carriage Types';
include_once("../common/dbConnection.php");
include_once("../common/header.php");

$sql = "SELECT   * FROM carriage_type".$orderByQuery.$limitQuery;
$result = MYSQL_QUERY($sql);
$numberOfRows = MYSQL_NUM_ROWS($result);

echo '<a href="enterNewCarriageType.php">Add new carriage type</a><hr/>';
?>
<?
if ($numberOfRows==0) {  
?>
...
?>
	...
	<TD><a href="editCarriageType.php?id=<? echo $thisId; ?>">Edit</a></TD>
	<TD><a href="confirmDeleteCarriageType.php?id=<? echo $thisId; ?>">Delete</a></TD>
	</TR>
<?
		$i++;
