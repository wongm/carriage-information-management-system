...
?>
<h2>Enter Railcar_type</h2>
<form name="railcar_typeEnterForm" method="POST" action="insertNewRailcarType.php">
...
<input type="submit" name="submitEnterRailcar_typeForm" value="Enter Railcar_type">
