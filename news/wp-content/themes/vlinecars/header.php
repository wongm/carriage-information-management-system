...
<title>V/LineCars.com - <?php bloginfo('name'); ?> <?=$custom ?><?php if ( is_single() ) { ?> - Archives <?php } ?> <?php wp_title('-'); ?></title>
...
ddaccordion.init({
        ...
        defaultexpanded: [<?=NEWS_MENU_TAB?>], //index of content(s) open by default [index1, index2, etc]. [] denotes no content
